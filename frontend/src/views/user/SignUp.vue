    ...
    <div class="wrap-contact3">
      ...
      <b-col>
        ...
        <b-row>
          <b-col>
            <b-form-group>
              ...
              <b-button @click="check_user_email">인증</b-button>
            </b-form-group>
          </b-col>
        </b-row>
        ...
        <b-row>
          <b-col>
            <b-form-group>
              <label style="float: left">인증번호</label>
              <b-form-input
                type="text"
                style="width: 50%; float: left"
      ...
      <div>
        <b-button
          class="send-button"
          @click="onCliclkFormButton"
          variant="success"
          >가입하기</b-button
        >

        <b-button variant="success"
          ><router-link class="text-decoration-none text-white" to="addSign"
            >추가정보입력</router-link
          ></b-button
        >
      </div>
