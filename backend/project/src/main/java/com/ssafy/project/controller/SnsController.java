...
public class SnsController {
    ...
    private ResponseEntity<SnsResultDto> snsImageInsert(@PathVariable int snsNo,
    ...
    private ResponseEntity<SnsResultDto> snsDetail(@PathVariable int snsNo, HttpSession session) throws Exception {
        ...
        // snsParamDto.setUserNo( ((UserDto)
        // session.getAttribute("userDto")).getUserNo());
